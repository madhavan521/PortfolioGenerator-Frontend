  ...
  return (  
    <div className="container mt-5">  
      ...
      <div className="row mb-4">  
        <h3 className="text-dark text-center">Explore Our Portfolio Designs</h3>  
        <p className="text-center text-muted">  
          Select a design and start building a unique portfolio that showcases your skills and achievements.  
        </p>  
      </div>  
            ...
            <Fade direction="up" triggerOnce>  
              <div className="card shadow-sm border-0 transition-shadow hover-shadow mb-4">  
                ...
                <div className="card-body text-center">  
                  ...
                  <Link to={`/${item.link}`} className='text-light text-decoration-none'> View Your Portfolio  </Link>
                  </a>   
                </div>  
              </div>  
            </Fade>  
