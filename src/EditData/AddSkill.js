            ...
            <div className="card">  
                <div className="card-body">  
                    <form>  
                        ...
                        <button type="button" className="btn btn-info " onClick={handleSkill}>Add Skill</button>  
                  </div> 
                   </form>  
                   <div className='mt-3 d-flex justify-content-end align-item-end'>
           <button className='btn btn-warning' onClick={handleproject}>Back to Editpanel</button></div>
                </div>  
            </div>  
        </div>  
