...
const AddProject = () => {  
  ...
  const handleProjectSubmit = async () => {  
    ...
    .then(result => {  
      console.log(result);  
      toast.success("Project Addd Successfully and Continue To Add More Project");  
      setLoading(false);   
    })  
;  
  ...
  return (  
    <div className="container mt-5">  
      ...
      <div className=' mt-1 mb-4 me-2 d-flex justify-content-center align-item-center'>  
        <button className='btn btn-warning btn-lg' onClick={handleGenerate}>Back to EditPanel </button>  
      </div>  
    </div>  
  );  
};  
