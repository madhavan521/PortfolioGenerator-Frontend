...
const DemoDesign2Project = () => {
    const projectsData = [  
        ...
        {  
          name: "Gym Website",  
          description: "I developed a dynamic gym website using React, designed to provide users with an engaging platform for fitness information.",  
...
export default DemoDesign2Project;
